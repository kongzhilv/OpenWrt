...
echo "===== DIY part2: rollback test - RAX3000M F50 WiFi SFTP ttyd Argon OpenList DiskMan only ====="
...
# DiskMan only, no USB storage, no block-mount, no extroot, no tempinfo
...
# Not enabled in this rollback-test step
